<div class="content">
    <div class="content-home-1">
        <div class="content-home__text">
            ...
            <p>Comenzamos explicando que es una aplicación CRUD básica, donde podrás:</p>
    ...
    <div class="content-home-2">
        ...
        <div class="content-home__text">
            <p>Si damos click a esta opción en la cabecera, se despliega el menú para poder navegar por la pagina,
    ...
    <div class="content-home-1">
        <div class="content-home__text">
            ...
            <ul class="content-home__text__list">
                <li>Inicio  ( Dirige a ésta misma pagina)</li>
